...
# 2. 앙상블할 모델 정의 (Optuna 파라미터 적용)
print("\n앙상블 모델을 정의합니다 (LGBM, XGB, CatBoost with Optuna params)...")
...
submission.to_csv('./soft_voting_final_submit.csv', index=False, encoding='utf-8-sig')

print("\nsoft_voting_final_submit.csv 파일 생성이 완료되었습니다.")
