...
print(f"\n>> 최종 앙상블 (CatBoost 포함) OOF F1 Score: {ensemble_f1:.4f}")
...
submission.to_csv('./soft_voting_cat_submit.csv', index=False, encoding='utf-8-sig')

print("\nsoft_voting_cat_submit.csv 파일 생성이 완료되었습니다.")
