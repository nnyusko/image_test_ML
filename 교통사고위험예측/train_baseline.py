...
# The sample submission has more Test_ids than the cleaned test data.
# We need to merge our predictions with the original sample submission file to ensure we have all test ids.
# We will fill any missing predictions with a neutral 0.5
...
final_submission.to_csv('C:/Users/user/Documents/GitHub/image_test_ML/교통사고위험예측/submit/baseline_submit.csv', index=False)
